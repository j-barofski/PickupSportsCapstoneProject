                                    ...
                                    <div className="offset-lg-1 col-lg-10 col-md-12 col-12">
                                        <div className="d-lg-flex align-items-center justify-content-between">
                                            <div className="mb-4 mb-lg-0">
                                                ...
                                                <p className="mb-0 text-white lead">Fill in the details for your event.</p>
                                            </div>
                                            <div>
                            ...
                            <div className="card mb-3">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <input onChange={handleCreateEventChange} name="title" value={event.title} className="form-control" type="text" placeholder="e.g. Saturday basketball at Riverside" />
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <textarea onChange={handleCreateEventChange} name="description" value={event.description} className="form-control" cols="30" rows="6" placeholder="What's this event about?"></textarea>
                                    ...
                                    <div className="mb-3">
                                        ...
                                        <select onChange={handleCreateEventChange} name="status" value={event.status} className="form-select">
